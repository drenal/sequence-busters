...
class LenardModel1(ModelBase):
    def __init__(self, in_features: int):
        """ Simple baseline model for prediction secondary structure
        Args:
            in_features: size in features
        """
        super(LenardModel1, self).__init__()

        # Task block
        self.ss8_in = nn.Linear(in_features=in_features, out_features=512)
        ...
        self.ss3_in = nn.Linear(in_features=in_features, out_features=256)
